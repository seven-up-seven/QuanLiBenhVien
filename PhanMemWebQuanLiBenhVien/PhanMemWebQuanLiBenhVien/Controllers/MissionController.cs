...
namespace PhanMemWebQuanLiBenhVien.Controllers
{
    ...
    public class MissionController : Controller
    {
        ...
        public IActionResult Update(Mission mission)
        {
            ...
            var tmpuser = _userManager.GetUserAsync(User).GetAwaiter().GetResult();
            var truetmp_user = (CustomedUser)tmpuser;
            trackingtool.TrackingActivity(truetmp_user.UserId, truetmp_user.UserName, ETypeOfActivity.sua, truetmp_user.UserRole, mission.MissionId, mission, details);
        ...
        public IActionResult Delete(int missionId)
        {
            ...
            var tmpuser = _userManager.GetUserAsync(User).GetAwaiter().GetResult();
            var truetmp_user = (CustomedUser)tmpuser;
            trackingtool.TrackingActivity(truetmp_user.UserId, truetmp_user.UserName, ETypeOfActivity.xoa, truetmp_user.UserRole, mission.MissionId, mission, null);
            _unitOfWork.Save();
        ...
        public IActionResult Tick(int id)
        {
            ...
            var tmpuser = _userManager.GetUserAsync(User).GetAwaiter().GetResult();
            var truetmp_user = (CustomedUser)tmpuser;
            trackingtool.TrackingActivity(truetmp_user.UserId, truetmp_user.UserName, ETypeOfActivity.hoanthanhmission, truetmp_user.UserRole, mission.MissionId, mission, null);
